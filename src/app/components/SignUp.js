          ...
          {title}
            <Form onSubmit={this.signUp}>
              <FormGroup controlId="forUsername">
                <Label style={{marginTop:"10px"}} for="username">Username</Label>
                <Input
                  type="text" 
              ...
              <FormGroup controlId="formEmail">
                <Label style={{marginTop:"10px"}} for="email">Email</Label>
                <Input required
                  type="text" 
              ...
              <FormGroup controlId="formPassword">
                <Label style={{marginTop:"10px"}} for="password">Password</Label>
                <Input required 
                  type="password" 
              ...
              <FormGroup controlId="formConfirmPassword">
                <Label style={{marginTop:"10px"}} for="password">Confirm Password</Label>
                <Input required 
                  type="password" 
              ...
              <FormGroup controlId="formAddress">
                <Label style={{marginTop:"10px"}} for="address">Address</Label>
                <Input required
                  type="text" 
              ...
              <Button style={{marginTop:"40px",backgroundColor:"#e4a663",border:"#db6504"}} variant="primary" type="submit">
                Sign-Up
              </Button>
              {
