...
class AppNavbar extends Component {
  ...
  render() {
    return <Navbar dark expand="md">
      <NavbarBrand  style={{color:"#e4a663"}} tag={Link} to="/home">K2</NavbarBrand>
      <Nav className="mr-auto">
        <NavLink  style={{color:"#e4a663"}} href="/home">Home</NavLink>
      ...
      <Collapse isOpen={this.state.isOpen} navbar>
        {
          this.state.login ? (
            ...
            <Nav className="ml-auto" navbar>
              <NavItem>
                <NavLink  style={{color:"#e4a663"}} className="heading" href="/signin">Login</NavLink>
              </NavItem>
              <NavItem>
                <NavLink  style={{color:"#e4a663"}} className="heading" href="/signup">SignUp</NavLink>
              </NavItem>
              {/* <NavItem>
                <NavLink  style={{color:"#e4a663"}} className="heading" href="/userdetails">User Details</NavLink>
              </NavItem> */}
